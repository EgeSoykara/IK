...
## Evidence: 2026-07-28 Personnel Excel, Required Fields, and Department Management
...
- The employee table and education toolbar expose accessible `Import Excel` and `Export Excel` actions while retaining the existing create and row actions. The department table shows `Departman Yöneticisi`, and the edit dialog explains that only active employees in that department are eligible.

...
- Bank, institution/program, city/district/country, issuer, and document-type fields use the existing `ManagementFilterOptionSearch` autocomplete authority with manual-value coercion. No fixed lookup dataset, external API, or runtime visual dependency was added.

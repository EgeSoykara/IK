...
namespace IK.Web.Migrations
{
    ...
    partial class LinkEmployeeDocumentsToPersonnelRecords
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IK.Web.Models.EmployeeDocument", b =>
                {
                    ...
                    b.HasIndex("EmployeeCourseCertificateId");

                    b.HasIndex("EmployeeEducationId");

                    b.HasIndex("EmployeeIdentityDocumentId");
            ...
            modelBuilder.Entity("IK.Web.Models.EmployeeDocument", b =>
                {
                    ...
                    b.HasOne("IK.Web.Models.EmployeeCourseCertificate", "CourseCertificate")
                        .WithMany("Documents")
                        .HasForeignKey("EmployeeCourseCertificateId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("IK.Web.Models.EmployeeIdentityDocument", "IdentityDocument")
                        .WithMany("Documents")
                        .HasForeignKey("EmployeeIdentityDocumentId")
                        .OnDelete(DeleteBehavior.Restrict);

...
namespace IK.Web.Migrations
{
    ...
    [Migration("20260803072742_DailyLeaveEntitlementsAndCategories")]
    partial class DailyLeaveEntitlementsAndCategories
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IK.Web.Models.LeaveType", b =>
                {
                    ...
                    b.ToTable("LeaveTypes", null, t =>
                        {
                            t.HasCheckConstraint("CK_LeaveTypes_EntitlementKind", "[EntitlementKind] BETWEEN 0 AND 5");

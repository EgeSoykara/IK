        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnualQuotaDays = table.Column<decimal>(type: "decimal(7,2)", precision: 7, scale: 2, nullable: false),
                    MaxAccrualWarningDays = table.Column<decimal>(type: "decimal(7,2)", precision: 7, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegionManagerEmployeeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmployeeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SicilNo = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    FirstName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    KKTC_KimlikNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntitledDays = table.Column<decimal>(type: "decimal(7,2)", precision: 7, scale: 2, nullable: false),
                    CarryOverDays = table.Column<decimal>(type: "decimal(7,2)", precision: 7, scale: 2, nullable: false),
                    UsedDays = table.Column<decimal>(type: "decimal(7,2)", precision: 7, scale: 2, nullable: false),
                    RemainingDays = table.Column<decimal>(type: "decimal(7,2)", precision: 7, scale: 2, nullable: false),
                    CarryOverLimitWarningConfirmed = table.Column<bool>(type: "bit", nullable: false),
                    CarryOverLimitWarningConfirmedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    CarryOverLimitWarningConfirmedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedDays = table.Column<decimal>(type: "decimal(7,2)", precision: 7, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Employees_ManagerApproverEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_RegionManagerEmployeeId",
                table: "Departments",
                column: "RegionManagerEmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveApprovals_RequestId_ApproverRole",
                table: "LeaveApprovals",
                columns: new[] { "RequestId", "ApproverRole" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_CurrentStatus",
                table: "LeaveRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_ManagerApproverEmployeeId",
                table: "LeaveRequests",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Departments_Employees_RegionManagerEmployeeId",
                table: "Departments",
                column: "RegionManagerEmployeeId",
                principalTable: "Employees",
                principalColumn: "EmployeeId",

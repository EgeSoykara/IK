...
namespace IK.Web.Migrations
{
    ...
    [Migration("20260820075814_AddEmployeeCredentialsAndEmailLogin")]
    partial class AddEmployeeCredentialsAndEmailLogin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IK.Web.Models.AuditLog", b =>
                {
                    ...
                    b.ToTable("AuditLogs", null, t =>
                        {
                            t.HasCheckConstraint("CK_AuditLogs_ActionType", "[ActionType] BETWEEN 1 AND 44");
            ...
            modelBuilder.Entity("IK.Web.Models.EmployeeCredential", b =>
                {
                    b.Property<int>("EmployeeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IK.Web.Models.EmployeeCredential", b =>
                {
                    b.HasOne("IK.Web.Models.Employee", "Employee")
                        .WithOne("Credential")
                        .HasForeignKey("IK.Web.Models.EmployeeCredential", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

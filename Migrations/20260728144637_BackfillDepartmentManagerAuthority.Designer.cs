...
namespace IK.Web.Migrations
{
    ...
    [Migration("20260728144637_BackfillDepartmentManagerAuthority")]
    partial class BackfillDepartmentManagerAuthority
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IK.Web.Models.AuditLog", b =>
                {
                    ...
                    b.ToTable("AuditLogs", null, t =>
                        {
                            t.HasCheckConstraint("CK_AuditLogs_ActionType", "[ActionType] BETWEEN 1 AND 31");
                        });
                });

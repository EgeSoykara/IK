...
namespace IK.Web.Migrations
{
    ...
    [Migration("20260806105206_AddLeaveCancellationWorkflowAndRetrospectiveRequests")]
    partial class AddLeaveCancellationWorkflowAndRetrospectiveRequests
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("LeaveCancellationRequests", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_LeaveCancellationRequests_DateRange", "[ReturnDate] <= [OriginalEndDate]");
            ...
            modelBuilder.Entity("IK.Web.Models.LeaveRequest", b =>
                {
                    ...
                    b.Navigation("ManagerDelegation");
                });

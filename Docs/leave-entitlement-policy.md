...
50 gün genel izin türleri için bir kesme sınırı değildir. Manuel işlemde sınır aşımı açık onay ister. Seferberlik İzni'nin 2 günlük sınırı ise serttir; uyarı onayı bunu aşamaz. Günlük otomatik uzlaştırma genel hakkı kesmeden kaydeder; devir nedeniyle sınır aşılmışsa `/LeaveCarryOverWarnings` sayfasında devreden gün, yeni hak, toplam ve uyarı sınırıyla kalıcı bir uyarı oluşturur. Yetkili yönetici bu sayfada uyarıyı inceleyebilir veya devreden günü negatif olmayan tam/yarım gün olarak düzenleyebilir. Düzenleme gerçek `LeaveBalance` kaydını ve kalan günü atomik günceller; toplam düşüm kaynakları kullanılan günle tutarlı olmalı ve devreden gün onaylı taleplerde devreden kaynaktan kullanılmış miktarın altına inemez. Yeni toplam sınırı aşmıyorsa uyarı kapanır, aşmaya devam ediyorsa yeni tutarla tekrar inceleme bekler. Sayfa, inceleme ve düzenleme işlemleri sunucu tarafında `CanManageLeaveBalances` iznini gerektirir ve audit kaydı üretir.

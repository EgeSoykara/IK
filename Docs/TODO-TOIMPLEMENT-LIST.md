...
- [x] Reuse the existing management UI pattern across personnel CRUD pages and use existing-value autocomplete with manual entry for school/program, bank, city/district/country, issuer, and similar fields without adding invented reference data or an external API. Evidence: `Components/Pages/Employee*.razor`, `Components/ManagementFilter.cs`, and `wwwroot/app.css`.

...
- [x] Keep the dashboard free of upload controls, place profile-photo upload on `Genel Bilgiler`, and attach identity, diploma, and certificate files to their related structured record. Preserve and safely backfill existing documents without granting unauthorized cross-employee access. Evidence: `Components/Pages/EmployeeGeneralInformation.razor`, `Components/Pages/EmployeeIdentityDocuments.razor`, `Components/Pages/EmployeeEducations.razor`, `Components/Pages/EmployeeCourseCertificates.razor`, `Services/EmployeeFileService.cs`, and `Migrations/20260727110418_LinkEmployeeDocumentsToPersonnelRecords.cs`.
